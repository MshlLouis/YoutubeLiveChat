# A Bot for Youtube that allows the user to connect to Youtube Channels to read Livestream Chat Messages and Super Chats. Saves all these events to a Database.
